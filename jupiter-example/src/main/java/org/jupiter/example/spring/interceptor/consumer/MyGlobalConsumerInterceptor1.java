 ...
 * @author jiachun.fjc
 */
public class MyGlobalConsumerInterceptor1 implements ConsumerInterceptor {

    @Override
    public void beforeInvoke(TraceId traceId, JRequest request, JChannel channel) {
        System.err.println("global 1 beforeInvoke#" + traceId + " " + request + " channel=" + channel);
    }

    @Override
    public void afterInvoke(TraceId traceId, JResponse response, JChannel channel) {
        System.err.println("global 1 afterInvoke#" + traceId + " " + response + " channel=" + channel);
    }
}
